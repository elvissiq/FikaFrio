...
Static Function fnF01Pro()
  ...
  If lProcesOK
     ...
     cMsgExc := "ApMsgAlert('ERRO no processamento, verifique o Log.','ATENÇÃO')"
  EndIf
...
Static Function fnF01Grv(pEmpresa, pFilial, nId)
  ...
  aAdd(aCab, {"DAK_COD"   , oFusion:oParseJSON[nId]:t10_id                      , Nil})
  ...
  If lGerar
     ...
     If lMsErroAuto
        ...
        aAdd(aErro, "ERRO da Carga: " + oFusion:oParseJSON[nId]:t10_id + CRLF)
       ...
       // -----------------------------------
        ...
        aAdd(aErro, "Sucesso na execução, Carga: " + oFusion:oParseJSON[nId]:t10_id)
        
        oFusion:setIntErp(oFusion:oParseJSON[nId]:CODIGO_INT, oFusion:oParseJSON[nId]:t10_id)
